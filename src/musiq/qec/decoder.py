...
from musiq.common.schemas import DecoderInput, DecoderOutput, LogicalErrorSummary
from musiq.qec.interfaces import IDecoder
...
def get_decoder(name: str) -> IDecoder:
    ...
    if key == "mwpm":
        return MWPMDecoder()
    from musiq.qec.mock import MockDecoder
