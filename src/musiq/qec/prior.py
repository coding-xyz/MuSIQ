...
from musiq.common.schemas import PriorModel, SyndromeFrame, utc_now_iso
from musiq.qec.interfaces import IPriorBuilder
...
def build_prior_and_report(
    ...
    if key == "stim":
        ...
        from musiq.qec.mock import MockPriorBuilder
